...
const dirApp = path.join(dirRoot, 'app')
const dirAssets = path.join(dirRoot, 'assets')
const dirShared = path.join(dirRoot, 'shared')
const dirStyles = path.join(dirRoot, 'styles')
const dirNode = 'node_modules'

module.exports =
{
  entry: [path.join(dirApp, 'index.js'), path.join(dirStyles, 'index.styl')],
